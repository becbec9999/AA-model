...
| 版本 | 日期 | 更新内容 |
|------|------|----------|
| V5.5 | 2026-04-13 | 修复页面加载圈问题，本地化 Plotly.js |
| V5.4 | 2026-04-13 | 修复前端图表渲染问题（直线/空图） |
| V5.3 | 2026-03-23 | 代码审查修复（S1-S3级12个问题） |
| V5.2 | 2026-03-22 | 时间范围优化，新增2Y/3Y/5Y选项 |
| V5.1 | 2026-03-21 | FastAPI架构重构 |
