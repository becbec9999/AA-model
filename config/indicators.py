...
INDICATOR_PATTERNS = {
    ...
    'ma_turnover': {'category': '量价类', 'type': '趋势', 'name': '换手率均线', 'window': True},
    ...
    'market_amt_ratio': {'category': '量价类', 'type': '情绪', 'name': '成交额占全市场比重', 'window': False},
    ...
    'rsi_analysis': {'category': '量价类', 'type': '动量', 'name': 'RSI分析', 'window': False},
}
